...
class View_TopView extends \View{
	function setModel($m){
		...
		$this->js('click')->_selector('.do-view-project-lives-details')->univ()->frameURL('Project Lives Details',[$this->api->url('xepan_projects_projectlive'),'project_id'=>$this->js()->_selectorThis()->closest('[data-id]')->data('id')]);
