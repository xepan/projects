...
class Model_Formatted_Project extends \xepan\projects\Model_Project{
	function init(){
		...
		$this->addExpression('self_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('project_id',$this->getElement('id'))->count());

		$this->addExpression('self_pending_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('project_id',$this->getElement('id'))->addCondition('status',['Pending'])->count());
		...
		$this->addExpression('self_critical_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('project_id',$this->getElement('id'))->addCondition('priority','90')->count());

		$this->addExpression('critical_self_pending_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('status',['Pending'])->addCondition('project_id',$this->getElement('id'))->addCondition('priority','90')->count());
		...
		$this->addExpression('self_high_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('project_id',$this->getElement('id'))->addCondition('priority','75')->count());

		$this->addExpression('high_self_pending_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('status',['Pending'])->addCondition('project_id',$this->getElement('id'))->addCondition('priority','75')->count());
		...
		$this->addExpression('self_medium_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('project_id',$this->getElement('id'))->addCondition('priority','50')->count());

		$this->addExpression('medium_self_pending_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('status',['Pending'])->addCondition('project_id',$this->getElement('id'))->addCondition('priority','50')->count());
		...
		$this->addExpression('self_low_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('project_id',$this->getElement('id'))->addCondition('priority','25')->count());

		$this->addExpression('low_self_pending_task')->set($this->refSQL('xepan\projects\Task')->addCondition('employee_id',$this->app->employee->id)->addCondition('project_id',$this->getElement('id'))->addCondition('status',['Pending'])->addCondition('priority','25')->count());
